...
This is a copy of react-simplemde-editor@4.1.0

I removed the state, since in this app it is used an a controlled component and
the state was causing update bugs when switching between notes. This is because
if you switch notes without making edits, the internal state stays the same and
prevents updates (see componentDidUpdate in original code).
